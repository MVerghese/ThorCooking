...
def main():
	# test_eval()
	# 1/0
	# print(specific_eval("make a latte",1,5, selection_strategy = "prob"))
	...
	# start_indices = [4]
	save_path = "Results/GT_History_Llama3-2-11B_Prob_MCQ_Selection_Latte_Task_Graph_Move_Action/"
	if not os.path.exists(save_path):
		os.makedirs(save_path)
	success_array, success_per_env, success_per_start, success_rate = full_eval("make a latte",successful_floorplans,start_indices, evals = 1, selection_strategy = "prob", save_path = save_path)
	print(success_array)
