...
class SeViLa_Interface:
    def __init__(self, model_path = '/home/mverghese/HypothesisTesting/SeViLA/sevila_checkpoints/sevila_pretrained.pth', cuda_device = 0):
        img_size = 224
        ...
        self.QA_prompt = 'Considering the information presented in the frame, answer the question.'
        mean = (0.48145466, 0.4578275, 0.40821073)
        std = (0.26862954, 0.26130258, 0.27577711)
        normalize = transforms.Normalize(mean, std)
        self.image_size = img_size
        self.transform = transforms.Compose([ToUint8(), ToTHWC(), transforms_video.ToTensorVideo(), normalize])
    ...
    def inference(self,frames,question, num_keyframes = 4):
        ...
        out = self.sevila.generate_demo(frames, text_input_qa, text_input_loc, int(num_keyframes))
        # print(out)
