...
class Base_Agent:
	def __init__(self,language_model = "Llama-3-8b-chat-hf/", load_llm = True, load_narrator = True, selection_method = "sim"):
		if load_llm:
	...
	def build_prompt(self,task,narration_history,examples, mode = "completion", last_failed_action = ""):
	...
	def select_action_prob(self,task,action_list,history,probablistic_selection=False, verbose = False, last_failed_action = ""):
		examples = self.select_few_shot_examples(task,3)
		prompt = self.build_prompt(task,history,examples, mode = "question", last_failed_action = last_failed_action)
	...
	def select_action_sim(self,task,action_list,history,probablistic_selection=False, verbose = False, last_failed_action = ""):
		examples = self.select_few_shot_examples(task,3)
	...
	def select_action(self,task,action_list,history,probablistic_selection=False, verbose = False, last_failed_action = ""):
		if self.selection_method == "sim":
			return self.select_action_sim(task,action_list,history,probablistic_selection, verbose, last_failed_action)
		elif self.selection_method == "prob":
			return self.select_action_prob(task,action_list,history,probablistic_selection, verbose, last_failed_action)
		else:
